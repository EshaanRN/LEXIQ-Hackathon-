    ...
    <>
      {!onCoach && (
        <Link
          ...
          className="fixed bottom-20 right-4 z-40 flex items-center gap-2 rounded-full border border-primary/40 bg-card/90 py-2 pl-2 pr-4 shadow-lg backdrop-blur transition hover:-translate-y-0.5 hover:border-primary active:scale-95 mb-[env(safe-area-inset-bottom)]"
        >
